...
$sql = "SELECT MASTER.GAME_ID, MASTER.PHASE_ID, MASTER.GAME_DATE, MASTER.TEAM_A, MASTER.TEAM_B, 
			...
			BETS.BET_POINTS FROM MASTER, BETS  WHERE MASTER.GAME_ID = BETS.GAME_ID AND BETS.USERID = " . $_SESSION["userid"] . " AND MASTER.PHASE_ID = 'A' ORDER BY MASTER.PHASE_ID, MASTER.GAME_ID";
